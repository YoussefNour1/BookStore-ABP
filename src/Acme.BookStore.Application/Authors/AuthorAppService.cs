...
namespace Acme.BookStore.Authors
{
    ...
    public class AuthorAppService(IAuthorRepository authorRepository, AuthorManager authorManager) : BookStoreAppService, IAuthorAppService
    {
        ...
        public async Task<PagedResultDto<AuthorDto>> GetListAsync(GetAuthorListDto input)
        {
            ...
            var totalCount = input.Filter == null?await _authorRepository.CountAsync() : await _authorRepository.CountAsync(a=> a.Name.Contains(input.Filter));
