...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 989a8654-fae5-4c1e-a87f-085d97a9b1a5
```

> `989a8654-fae5-4c1e-a87f-085d97a9b1a5` is the password of the certificate, you can change it to any password you want.
